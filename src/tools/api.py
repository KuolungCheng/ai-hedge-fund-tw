...
def get_financial_metrics(
    ...
    for idx, snap in enumerate(snapshots):
        ...
        metric = FinancialMetrics(
            ...
            price_to_earnings_ratio=snap["price_to_earnings_ratio"],
            price_to_book_ratio=snap["price_to_book_ratio"],
            price_to_sales_ratio=snap["price_to_sales_ratio"],
            enterprise_value_to_ebitda_ratio=snap["enterprise_value_to_ebitda_ratio"],
            enterprise_value_to_revenue_ratio=snap["enterprise_value_to_revenue_ratio"],
            free_cash_flow_yield=snap["free_cash_flow_yield"],
            ...
            return_on_assets=snap["return_on_assets"],
            return_on_invested_capital=snap["return_on_invested_capital"],
            asset_turnover=snap["asset_turnover"],
            inventory_turnover=snap["inventory_turnover"],
            receivables_turnover=snap["receivables_turnover"],
            days_sales_outstanding=snap["days_sales_outstanding"],
            operating_cycle=snap["operating_cycle"],
            working_capital_turnover=snap["working_capital_turnover"],
            current_ratio=snap["current_ratio"],
            quick_ratio=snap["quick_ratio"],
            cash_ratio=snap["cash_ratio"],
            operating_cash_flow_ratio=snap["operating_cash_flow_ratio"],
            debt_to_equity=snap["debt_to_equity"],
            debt_to_assets=snap["debt_to_assets"],
            ...
            payout_ratio=(
                abs(snap["dividends_and_other_cash_distributions"]) / abs(snap["net_income"])
            ...
            free_cash_flow_per_share=snap["free_cash_flow_per_share"],
        )
